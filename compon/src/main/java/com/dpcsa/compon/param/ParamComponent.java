...
public class ParamComponent <T>{
    public static enum TC {PANEL, PANEL_ENTER,
        SPINNER, DRAWER, PLUS_MINUS, CALENDAR, SWITCH, SUBSCRIBE, SUBSCRIBE_TOPIC,
        RECYCLER, //        RECYCLER_HORIZONTAL, RECYCLER_GRID, RECYCLER_EXPANDED, RECYCLER_STICKY,
        TOOL, AUTO_AUTCH, TAGS, TOOL_MENU,
        MENU, MENU_B, CONTAINER, MAP, SEQUENCE, BUTTON, PHONE, TOTAL, SEARCH, PHOTO, RECOGNIZE_VOICE,
        STATIC_LIST, MODEL, PAGER_V, PAGER_F, INTRO, POP_UP, DATE_DIAPASON, BARCODE, LOAD_DB, CUSTOM, EDIT_GALLERY,
        ENABLED, YOU_TUBE};
